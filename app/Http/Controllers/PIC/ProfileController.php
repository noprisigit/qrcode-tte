...
class ProfileController extends Controller
{
  ...
  {
    return view('pic.profile.profile-index');
  }
  ...
  public function edit()
  {
    ...
    return view('pic.profile.profile-edit', compact('dinas', 'user', 'sub_bidang'));
  }
  ...
  public function update(UserUpdateProfileRequest $request)
  {
    ...
    Pegawai::updateOrCreate(
      ...
      [
        ...
        'tempat_lahir' => $validated['pob'],
        'tanggal_lahir' => $validated['dob'],
  ...
  {
    return view('pic.profile.profile-change-password');
  }
