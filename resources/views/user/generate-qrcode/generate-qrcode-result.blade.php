<table class="">
  <tr>
    ...
    <td class="p-0 text-start ps-1 pt-4" style="vertical-align: top; border-top: 4px solid black; border-right: 4px solid black;">
      ...
      <p class="mb-0 text-dark fw-bold text-uppercase" style="font-family:Arial, Helvetica, sans-serif; font-size: 20px;">Kepala @if (auth()->user()->dinas_id) {{ auth()->user()->dinas->nama }} @endif Provinsi Kepulauan Bangka Belitung</p>
    </td>
  </tr>
  <tr>
