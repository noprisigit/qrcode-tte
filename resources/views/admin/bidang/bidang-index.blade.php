  ...
  <div class="modal modal-borderless fade text-left" id="modalAdd" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
      <div class="modal-content">
        <form action="{{ route('admin.bidang.store') }}" method="post" id="form-create">
          @csrf
            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  <label for="dinas_id">{{ __('Dinas') }}</label>
                ...
                <div class="form-group">
                  <label for="nama">{{ __('Nama Bidang') }}</label>
                  <input type="text" id="nama" class="form-control" name="nama" placeholder="Nama Bidang">
                  <span class="invalid-feedback" id="nama"></span>
                </div>
              </div>
            </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <table class="table" id="data-table">
        ...
        <tbody>
          @foreach ($bidang as $k => $item)
            <tr>
              <td>{{ ++$k }}</td>
              <td>{{ $item->dinas->nama }}</td>
              <td>{{ $item->nama }}</td>
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <span class="invalid-feedback" id="dinas_id"></span>
              </div>
              <div class="form-group">
                <label for="nama">{{ __('Nama Bidang') }}</label>
                <input type="text" id="nama" class="form-control" name="nama" placeholder="Nama Bidang">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('.btn-edit').on('click', function(e) {
      ...
      $('#form-edit #dinas_id').val($(this).attr('data-dinas')).trigger('change');
    });
