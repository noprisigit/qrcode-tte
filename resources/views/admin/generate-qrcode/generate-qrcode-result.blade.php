<table class="">
  <tr>
    ...
    <td class="p-0 text-start ps-1 pt-4" style="vertical-align: top; border-top: 4px solid black; border-right: 4px solid black;">
      ...
      <p class="mb-0 text-dark fw-bold text-uppercase" style="font-family:Arial, Helvetica, sans-serif; font-size: 20px;">@if ($user->dinas_id) {{ $user->dinas->nama }} @endif Provinsi Kepulauan Bangka Belitung</p>
    </td>
  </tr>
  <tr>
    <td class="p-0 text-start ps-1 pb-4 pe-4" style="vertical-align: bottom; border-bottom: 4px solid black; border-right: 4px solid black;">
      <p class="mb-0 text-dark fw-bold" style="font-family: Arial, Helvetica, sans-serif; font-size: 20px">{{ $user->nama }}</p>
      <p class="mb-0 text-dark" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px;">
        @if ($user->pegawai) {{ $user->pegawai->pangkat }} @endif
        @if ($user->pegawai) ({{  $user->pegawai->golongan }}) @endif
      </p>
    </td>
  </tr>
</table>