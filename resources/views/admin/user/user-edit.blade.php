      ...
      <div class="row">
        <div class="col-md-6 col-12">
          <div class="form-group">
            ...
            <input type="number" min="0" name="nik" id="nik" class="form-control @error('nik') is-invalid @enderror" 
              value="{{ old('nik', $user->pegawai->nik) }}" placeholder="NIK" readonly>
            @error('nik')
        ...
        <div class="col-md-6 col-12">
          <div class="form-group">
            ...
            <input type="number" min="0" name="nip" id="nip" class="form-control @error('nip') is-invalid @enderror" 
              value="{{ old('nip', $user->pegawai->nip) }}" placeholder="NIP" readonly>
            @error('nip')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
        ...
        <div class="col-md-6 col-12">
          <div class="form-group">
            ...
            <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" 
              value="{{ old('nama', $user->nama) }}" placeholder="Nama">
            @error('nama')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
        ...
        <div class="col-md-6 col-12">
          <div class="form-group">
            ...
            <input type="number" min="0" name="no_telp" id="no_telp" class="form-control @error('no_telp') is-invalid @enderror" 
              value="{{ old('no_telp', $user->no_telp) }}" placeholder="Nomor Telepon">
            @error('no_telp')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
        ...
        <div class="col-md-6 col-12">
          <div class="form-group">
            ...
            <select name="jenis_kelamin" id="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror">
              ...
              <option value="Laki-Laki" @if(Request::old('jenis_kelamin') == 'Laki-Laki' || $user->pegawai->jenis_kelamin == 'Laki-Laki') selected @endif>{{ __('Laki-Laki') }}</option>
              <option value="Perempuan" @if(Request::old('jenis_kelamin') == 'Perempuan' || $user->pegawai->jenis_kelamin == 'Perempuan') selected @endif>{{ __('Perempuan') }}</option>
            </select>
            @error('jenis_kelamin')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        ...
        <div class="col-md-6 col-12">
          <div class="form-group">
            ...
            <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" 
              value="{{ old('tempat_lahir', $user->pegawai->tempat_lahir) }}" placeholder="Tempat Lahir">
            @error('tempat_lahir')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
        ...
        <div class="col-md-6 col-12">
          <div class="form-group">
            ...
            <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror" 
              value="{{ old('tanggal_lahir', $user->pegawai->tanggal_lahir) }}" placeholder="Tanggal Lahir">
            @error('tanggal_lahir')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <select name="dinas_id" id="dinas_id" class="form-control @error('dinas_id') is-invalid @enderror">
              ...
              @foreach ($dinas as $item)
                @if (Request::old('dinas_id') == $item->id || $user->dinas_id == $item->id)  
          ...
          <div class="form-group">
            ...
            <select name="sub_bidang_id" id="sub_bidang_id" class="form-control @error('sub_bidang_id') is-invalid @enderror">
              ...
              @foreach ($bidang as $item)
                @if (Request::old('sub_bidang_id') == $item->id || $user->sub_bidang_id == $item->id)
                  <option value="{{ $item->id }}" selected>{{ $item->nama }}</option>
                @else
                  <option value="{{ $item->id }}">{{ $item->nama }}</option>
                @endif
        ...
        <div class="col-md-6 col-12">
          <div class="form-group">
            ...
            <input type="text" name="pangkat" id="pangkat" class="form-control @error('pangkat') is-invalid @enderror" 
              value="{{ old('pangkat', $user->pegawai->pangkat) }}" placeholder="Pangkat">
            @error('pangkat')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
        ...
        <div class="col-md-6 col-12">
          <div class="form-group">
            ...
            <input type="text" name="golongan" id="golongan" class="form-control @error('golongan') is-invalid @enderror" 
              value="{{ old('golongan', $user->pegawai->golongan) }}" placeholder="Golongan">
            @error('golongan')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="role" id="role_admin" 
                value="{{ \App\Models\User::ROLE_ADMIN }}" @if ($user->role_id == \App\Models\User::ROLE_ADMIN) checked @endif>
              <label class="form-check-label" for="role_admin">
                Administrator
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="role" id="role_pic" 
                value="{{ \App\Models\User::ROLE_PIC }}" @if ($user->role_id == \App\Models\User::ROLE_PIC) checked @endif>
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="role" id="role_user" 
                value="{{ \App\Models\User::ROLE_USER }}" @if ($user->role_id == \App\Models\User::ROLE_USER) checked @endif>
        ...
        <div class="col-md-6 col-12">
          <div class="form-group">
            <label for="role">{{ __('Status Akun') }}</label>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="status" id="status_active" 
                value="{{ \App\Models\User::STATUS_ACTIVE }}" @if ($user->status == \App\Models\User::STATUS_ACTIVE) checked @endif>
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="status" id="status_inactive"" 
                value="{{ \App\Models\User::STATUS_INACTIVE }}" @if ($user->role_id == \App\Models\User::STATUS_INACTIVE) checked @endif>
